...
v2.0 的五张核心图、三张站点相对剖面和四份 PDF 由本地渲染流程根据本包的临时边界、设计图层和结构化指标绘制；渲染辅助代码不属于投稿交付物。其铁路、公园、门厅、庭院、可变内装、照护和服务关系均为概念原型，不是现状测绘、渲染实景、官方效果图或工程图纸；图中抽象人物和树木是原创符号，不代表真实居民、工作人员或场地状态。
